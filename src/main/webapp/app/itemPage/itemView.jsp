					...
					<div id="itemSubImgBox">
						...
						<c:forEach var="imgpath" items="${itemDto.item_imgpath}">
							...
							<img id="mainImg" src="${imgpath}" alt=""
								style="left:${120*imgCnt}px" onerror="this.style.display='none'" />
			...
			<div id="itemSecRightBox">
				<div id="totalChargeBox">
					...
					<div id="dateAndMen">
						...
						<p class="chargePeople">
							아동 <span> <i class="fa-solid fa-minus btnStCircle"></i> <input
								data-ch="child" type="number" min="0" max="8" value="0" readonly />
				...
				<div id="roomMoreInfoBox">
					...
					<div id="roomMoreRightBox">
						...
						<label for="에어컨">에어컨</label> <input name="room_extraopt" id="TV"
							...
							type="checkbox" value="커피포트" /> <label for="커피포트">커피포트</label> <input
							name="room_extraopt" id="욕실용품" type="checkbox" value="욕실용품" /> <label
							for="욕실용품">욕실용품</label> <br /> <input name="room_extraopt"
							id="드라이기" type="checkbox" value="드라이기" /> <label for="드라이기">드라이기</label>
						<input name="room_extraopt" id="비데" type="checkbox" value="비데" />
						<label for="비데">비데</label> <input name="room_extraopt" id="개별테라스"
							type="checkbox" value="개별테라스" /> <label for="개별테라스">개별테라스</label>
					</div>
				</div>
			</form>
