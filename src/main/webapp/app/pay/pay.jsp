	...
	<div class="centerCont">
		...
		<div style="display: flex;">
			<div id="payLeftWrap">
				...
				<div>
					...
					<p>
						<span>구매총액</span> <span
							style="color: black; font-weight: 600; font-size: 20px">10000원</span>
					</p>
					<p>
						<button type='button' class="whiteBtnSt" style="font-size: 16px">내 쿠폰</button>
						<span>-얼마</span>
					</p>
					<p>
						<span>사용가능 포인트 : ${memberDto.u_point} P </span> <span
							style="color: black;"> <input id="p_point"
							max="${memberDto.u_point}" name="p_point" type="number" value="0">P
						</span>
					</p>
				</div>
				<div>
					...
					<ul>
						...
						<li><input type='checkbox' id="thirdAgree" name="thirdAgree">
							<label for="thirdAgree">개인정보 제3자 제공 동의</label> <span>(필수)</span></li>
					</ul>
			...
			<form action="" type="method">
				<div id="payRightWrap">
					<p>숙소이름</p>
					<p>${itemDto.item_name}ddd</p>
					<p>객실타입/기간</p>
					<p>${roomDto.room_name}dd/dd${calendar.night}</p>
					<p>체크인</p>
					<p>${calendar.checkin}dd</p>
					<p>체크아웃</p>
					<p>${calendar.checkout }dd</p>
					<div>
		...
		<div id="outerPayBox">
			...
			<div id="payBox">
				...
				<p>1002-050-307547</p>
				<p >확인을 누르시면 결제대기상태가 됩니다
				<br>마이페이지 결제내역에서 확인가능합니다
				</p>
				<div>
