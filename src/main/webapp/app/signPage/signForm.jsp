    ...
    <div class="centerCont" style="width: 768px">
        ...
        <ul>
          ...
          <li>
            <input
              ...
              style="width: 500px"
            />
            <button id="phoneCertBtn" type="button">인증번호 받기</button>
          </li>
        </ul>
      <div id="signFormAgreeBox">
        <ul>
          <li>
            <input
            id="agreePhoneMarketing"
            name="agreePhoneMarketing"
            type="checkbox"
          />
          <label for="agreePhoneMarketing" class="checkBoxStyle-16">✓</label>
          <label for="agreePhoneMarketing">
            SMS, 이메일로 상품 및 이벤트 정보를 받겠습니다(선택)
          </label>
        </li>
          <li> 
            <input id="agreeAge" name="agreeAge" type="checkbox" required />
            <label for="agreeAge" class="checkBoxStyle-16">✓</label>
            <label for="agreeAge">14세 이상입니다</label>
            <span style="font-size: 14px; color: gray; ">(14세미만은 가입이 불가합니다)</span>
          </li>
        </ul>
