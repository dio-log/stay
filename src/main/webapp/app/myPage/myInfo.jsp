      ...
      <div style="display: flex; white-space: nowrap">
        <ul id="myTab">
          <li>
            <a
              href="myInfo.my"
              style="color: rgb(243, 21, 21); font-weight: 600"
              >내 정보 관리</a
            >
          </li>
           <c:choose>
 	 ...
 	 <li><a href="#">답변관리</a></li>
        ...
        <div id="myPageContentWrap">
          <div id="myPagePwCheckWrap">
            <p>
              회원님의 소중한 개인정보를 안전하게 보호하기위해 <br />
              로그인된 계정을 한번 더 인증해주세요
            </p>
            <span>비밀번호</span>
          ...
          <div id="myPageModifyWrap" style="display: none">
            <ul>
              <li>
                <i class="fa-solid fa-face-grin-wide fs-32"></i>
              </li>
              <li>
                <span>아이디</span>
                <span id="u_id"></span>
              ...
              <li>
                ...
                <input
                  id="foreignMarketing"
                  type="checkbox"
                  value="foreignMarketing"
                />
                <label for="foreignMarketing">제 3자 마케팅</label>
                <input id="smsMarketing" type="checkbox" value="smsMarketing" />
              ...
              <li>
                <hr />
                <a href="#" style="font-size: 14px"> 회원탈퇴 </a>
              </li>
            </ul>
          </div>
        </div>
