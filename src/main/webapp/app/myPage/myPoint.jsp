        ...
        <div id="myPageContentWrap">
          <div id="myPointWrap">
            <div id="currentPointBox">
              <p>내 포인트</p>
              <strong>0</strong><strong style="margin-left: 5px">P</strong>
            </div>
            <ul>
              <li>
                <input
                  ...
                  id="pointAll"
                  checked
                /><label for="pointAll">전체</label>
              </li>
              <li>
                <input name="myPoint" type="radio" id="pointSave" /><label
                  for="pointSave"
                  >적립</label
                >
              </li>
              <li>
                <input name="myPoint" type="radio" id="pointUsed" /><label
                  for="pointUsed"
                  >사용</label
                >
              </li>
              <li>
                <input name="myPoint" type="radio" id="pointExtinction" /><label
                  for="pointExtinction"
                  >소멸</label
                >
              </li>
